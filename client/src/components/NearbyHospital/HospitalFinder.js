...
const HospitalFinder=() =>
{
        ...
        const fetchHospitalsFromFirebase=async () =>
        {
                ...
                } catch ( error )
                {
                        ...
                        fetchNearbyHospitals(); // Fallback to fetch from external API if Firebase fetch fails
                }
        };
        ...
        const fetchNearbyHospitals=async () =>
        {
                try
                {
                        ...
                        const hospitalsData=response.data.map( ( hospital, index ) => ( {
                                ...
                                phone: 'Phone not available' // OSM data may not include phone numbers
                        } ) );
                        setHospitals( hospitalsData );
                        storeHospitalsInFirebase( hospitalsData ); // Store the fetched hospitals in Firebase
                        setLoading( false );
                } catch ( error )
                {
